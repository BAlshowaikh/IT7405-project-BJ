...
SECRET_KEY = 'django-insecure-)&qumdl-9wzh0zl)5i7+c#%h0s#3pp_v^per-e--$%ly*)6*fc'
...
# This tells python, In addition to app-level static folders, also look for static files in this directory.
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
